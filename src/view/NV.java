 ...
 * @author ViNguyen
 */
public class NV extends javax.swing.JDialog {

    private Main m;
    
    public NV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        m = (Main) parent;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(tenNV.equals("")||diaChi.equals("")||soDT.equals("")){
                JOptionPane.showMessageDialog(this, "Nhap lai");
            }else {
                jTextField1.setText(maNV+"");
                nv = new NhanVien(maNV,tenNV,diaChi,soDT);
                maNV++;
                m.themNV(nv);
            }
        }catch(Exception ex){}
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NV dialog = new NV(new javax.swing.JFrame(), true);
